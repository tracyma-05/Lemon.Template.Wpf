...
public class AppModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddKeyedServicesFromAssembly(typeof(AppModule).Assembly);
        context.Services.AddNavigationServiceFromAssembly(typeof(AppModule).Assembly);
    }
    ...
    public override async Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        var logger = serviceProvider.GetRequiredService<ILogger<AppModule>>();
