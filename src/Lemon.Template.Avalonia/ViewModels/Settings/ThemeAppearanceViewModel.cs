...
namespace Lemon.Template.Avalonia.ViewModels.Settings;
...
public partial class ThemeAppearanceViewModel : ObservableObject, ISingletonDependency, INavigationAware
{
    ...
    [ObservableProperty]
    private IBrush _primaryPreview = Brushes.Transparent;

    [ObservableProperty]
    private IBrush _secondaryPreview = Brushes.Transparent;
    ...
    {
        PrimaryPreview = new ImmutableSolidColorBrush(Color.FromRgb(
    ...
    {
        SecondaryPreview = new ImmutableSolidColorBrush(Color.FromRgb(
