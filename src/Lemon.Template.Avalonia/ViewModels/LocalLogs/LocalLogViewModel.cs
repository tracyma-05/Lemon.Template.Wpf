...
namespace Lemon.Template.Avalonia.ViewModels.LocalLogs;
...
public partial class LocalLogViewModel : ObservableObject, ITransientDependency
{
    ...
    /// <summary>Same folder Serilog writes to (see App.axaml.cs).</summary>
    private static string LogsDirectory => AppSqlitePaths.LogsFolder;
