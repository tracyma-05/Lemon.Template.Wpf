...
/// <summary>
/// Windows-only: a <c>.lnk</c> is created through the WScript.Shell COM object. Callers guard with
/// <see cref="OperatingSystem.IsWindows"/>; on macOS the feature is a no-op.
/// </summary>
